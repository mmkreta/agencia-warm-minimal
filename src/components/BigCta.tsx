const BigCta = () => (
  ...
  >
    <div className="max-w-[1600px] mx-auto">
      ...
      >
        Vaša konkurencia <span style={{ color: "#1a1a1a" }}>→</span> nečaká.
      </h2>
      <p
        className="reveal mt-8 max-w-[40ch] font-medium"
        style={{ fontSize: "clamp(1.1rem, 2vw, 1.5rem)" }}
      >
        Prvých 5 klientov tento mesiac — konzultácia zadarmo.
      </p>
      <a
        href="#kontakt"
      ...
      <div className="reveal mt-16 flex flex-wrap items-center gap-x-8 gap-y-3 text-[10px] uppercase tracking-[0.25em] font-medium">
        ...
        <span className="opacity-70">Max 5 klientov mesačne</span>
      </div>
    </div>
  </section>
);
